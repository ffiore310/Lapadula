...
def tabela_distancias (l1):
    ...
    for e in l1:
        if e[1] < 2500:
            nl += '{} {} {}\n'.format(retorna_cor(5, 252, 9,e[1]),retorna_cor(5, 252, 9,' km -->'),retorna_cor(5, 252, 9,e[0]))
        elif e[1] < 10000:
            nl += '{} {} {}\n'.format(retorna_cor(240, 252, 5,e[1]),retorna_cor(240, 252, 5,' km -->'),retorna_cor(240, 252, 5,e[0]))
        else:
            nl += '{} {} {}\n'.format(retorna_cor(252, 5, 5,e[1]),retorna_cor(252, 5, 5,' km -->'),retorna_cor(252, 5, 5,e[0]))
    return nl
